  ...
  return (
    <section className="relative bg-[#EDDEBA] py-12 pb-14">
      ...
      <div className="max-w-5xl mx-auto px-4 text-center">
        ...
        <div className="relative w-full flex justify-center items-center pb-8 bg-[#EDDEBA] overflow-hidden">
          <h1
            className="absolute text-[40px] sm:text-[50px] md:text-[67px] font-semibold opacity-50 select-none tracking-[0.001em] whitespace-nowrap text-[#4f4f4f]"
            style={{
              fontFamily: "Playfair Display",
              WebkitTextStroke: "1px #9ca3af",
              color: "transparent",
          ...
          <div className="flex items-center z-10">
            ...
            <h2
              className="text-[20px] sm:text-[24px] md:text-[32px] font-semibold text-[#012CDB]"
