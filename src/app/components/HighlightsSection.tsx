...
const highlights = [
    {
        img: "/KHimages/experts.png",
        title: "+5", // ✅ only here
        subtitle: "Hours of Expert Led Conference",
    },
    {
        img: "/KHimages/trophy.png",
        subtitle: "Cardiac Excellence Awards",
    },
    {
        img: "/KHimages/Exibition.png",
        subtitle: "Live Exhibition Gallery",
    },
    {
        img: "/KHimages/networking.png",
        subtitle: "Networking & Partnership",
    },
];
    ...
    return (
        <section className="bg-[#EDDEBA] pb-6 sm:pb-8 lg:pb-10">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div key={index} className="flex items-center justify-center">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-800 font-semibold max-w-[120px]">
                                        {item.subtitle}
                                    </p>
                                </div>
                            </div>
                ...
                {/* Desktop Layout */}
                <div className="hidden lg:flex items-center justify-center gap-2 xl:gap-4 2xl:gap-4">
                    {highlights.map((item, index) => (
                        <React.Fragment key={index}>
                            <div className="flex items-center gap-2 xl:gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm xl:text-base text-gray-800 font-semibold max-w-[140px] xl:max-w-[160px]">
                                        {item.subtitle}
                                    </p>
                                </div>
                            </div>
                            ...
                            {/* Separator */}
                            {index !== highlights.length - 1 && (
                                <div className="flex-shrink-0 mx-2 xl:mx-1">
                                    <div
                                        className="h-16 xl:h-20 bg-[#A21B43] rounded-full"
                                        style={{
                                            width: "4px",
