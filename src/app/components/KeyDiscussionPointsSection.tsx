        ...
        <section className="relative bg-[#EDDEBA] overflow-hidden">
            <div>
                    ...
                    <div className="relative w-full flex justify-center items-center py-4 sm:py-6 lg:py-8 bg-[#EDDEBA] overflow-hidden">
                        ...
                        <h1
                            className="absolute hidden sm:block text-[32px] sm:text-[45px] md:text-[55px] lg:text-[67px] font-semibold opacity-50 select-none tracking-[0.001em] whitespace-nowrap text-[#4f4f4f]"
                            style={{
                                fontFamily: "Playfair Display",
                                WebkitTextStroke: "1px #9ca3af",
                                color: "transparent"
                        ...
                        <div className="flex items-center z-10">
                            ...
                            <h2 
                                className="text-lg sm:text-xl md:text-2xl lg:text-[32px] font-semibold text-[#012CDB] px-2 sm:px-3"
